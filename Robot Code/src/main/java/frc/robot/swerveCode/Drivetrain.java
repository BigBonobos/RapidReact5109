...
public class Drivetrain {
  ...
  public void rotateToLimelightWanted() {
    OptionalDouble res = limelight.getXOffset();
    try {
      double real = res.getAsDouble();
      auto.rotateTo(Rotation2d.fromDegrees(real), Optional.of(0.5));
      auto.stop();
