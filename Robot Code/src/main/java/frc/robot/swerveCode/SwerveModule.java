...
public class SwerveModule {
  ...
  private static final double kEncoderResolutionDrive = 42 * 8.14;
  private static final double kEncoderResolutionTurn = 42 * 12.8;
  private static final int kCanCoderResolution = 4096;
